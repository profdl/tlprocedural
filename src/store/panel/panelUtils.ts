...
export const createDefaultPanels = (viewportHeight: number = 1080): Record<PanelId, PanelState> => {
  ...
  const defaultPanels = {
    properties: {
      ...
      size: { width: PANEL_WIDTH, height: 420 },
      originalSize: { width: PANEL_WIDTH, height: 420 },
      order: 0,
      isDragging: false
    },
    style: {
      ...
      isCollapsed: false,
      isVisible: true,
      position: { y: TOP_MARGIN + 420 + PANEL_GAP },
    ...
    modifiers: {
      ...
      isCollapsed: false,
      isVisible: true,
      position: { y: TOP_MARGIN + 420 + PANEL_GAP + 164 + PANEL_GAP },
